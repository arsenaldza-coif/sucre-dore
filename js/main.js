...
(function () {
  ...
  function bindContacts() {
    ...
    $("contactPhone").textContent = C.phoneDisplay;
    $("contactPhone").href = "tel:+" + C.whatsapp.number;
    $("contactEmail").textContent = C.email;
    $("contactEmail").href = "mailto:" + C.email;
    $("contactAddress").textContent = C.address[getLang()];
    $("contactHours").textContent = C.hours[getLang()];
    $("footerAddress").textContent = C.address[getLang()] || C.address.fr;
    $("footerPhone").textContent = C.phoneDisplay;
    $("footerPhone").href = "tel:+" + C.whatsapp.number;
    $("ctaPhone").textContent = C.phoneDisplay;
